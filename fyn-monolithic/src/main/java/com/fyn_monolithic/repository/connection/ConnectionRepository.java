...
public interface ConnectionRepository extends JpaRepository<Connection, UUID> {
        ...
        // List-based queries for getting all connections
        List<Connection> findAllByRequesterIdAndStatus(UUID requesterId, ConnectionStatus status);

        List<Connection> findAllByReceiverIdAndStatus(UUID receiverId, ConnectionStatus status);
