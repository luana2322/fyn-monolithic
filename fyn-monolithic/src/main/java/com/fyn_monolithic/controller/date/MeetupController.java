...
public class MeetupController {
        ...
        /**
         * Confirm meetup completion (post-meet)
         */
        ...
        public ResponseEntity<Map<String, Object>> confirmMeetup(
                ...
                String resultStr = body.get("result"); // "SUCCESS" or "NO_SHOW"
                MeetupConfirmation.ConfirmationResult result = MeetupConfirmation.ConfirmationResult.valueOf(resultStr);

                meetupMatchService.confirmMeetup(id, userDetails.getUser().getId(), result);
                return ResponseEntity.ok(Map.of(
                                "success", true,
